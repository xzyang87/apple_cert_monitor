...
module AppleCertMonitor
  class AppleDevClient < Thor
    ...
    desc "print_AppleDevClient", "print_AppleDevClient"
    def print_AppleDevClient
      puts "print_AppleDevClient"
    end
    ...
    #     puts "Now login in, please waiting......".green
